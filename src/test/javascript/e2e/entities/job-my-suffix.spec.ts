...
describe('Job e2e test', () => {
    ...
    it('should load Jobs', () => {
        ...
        expect(jobComponentsPage.getTitle()).toMatch(/jhipsterSampleApplication2222App.job.home.title/);
    ...
    it('should load create Job dialog', () => {
        ...
        expect(jobDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplication2222App.job.home.createOrEditLabel/);
        jobDialogPage.close();
    });
