...
describe('Task e2e test', () => {
    ...
    it('should load Tasks', () => {
        ...
        expect(taskComponentsPage.getTitle()).toMatch(/jhipsterSampleApplication2222App.task.home.title/);
    ...
    it('should load create Task dialog', () => {
        ...
        expect(taskDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplication2222App.task.home.createOrEditLabel/);
