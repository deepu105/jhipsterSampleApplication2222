...
describe('Employee e2e test', () => {
    ...
    it('should load Employees', () => {
        ...
        expect(employeeComponentsPage.getTitle()).toMatch(/jhipsterSampleApplication2222App.employee.home.title/);
    ...
    it('should load create Employee dialog', () => {
        ...
        expect(employeeDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplication2222App.employee.home.createOrEditLabel/);
